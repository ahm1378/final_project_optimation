...
class Controls(RunConcrete):
    ...
    def check_story_drift(self):
        name_of_table = 'Diaphragm Center Of Mass Displacements'
        result = self.etabs.DatabaseTables.GetTableForDisplayArray(name_of_table, [], '', 0, [], 0, [])
        header, data = result[2],result[4]
        return result
    ...
    def torsional_irregularity(self):
        ...
        torsion = torsion[torsion['Output Case'].isin(['EX', "EY"])]
